...
///
/// This Interface class defines the interfaces for use with a Qt-based plug-in that
/// knows how to interact with a specific REST API.  For example, a REST plug-in
/// for TeamCity would know how to query a server to retrieve information about the
...
public:     // methods
    ...
    /*!
      If a method returns an unexpected value, the host may retreive any
    ...
    /*!
      ...
      a dialog requesting these paramters and types from the user, and then
    ...
    /*!
      ...
      Password press credientials are provided if they are required by the
      particular REST API.
